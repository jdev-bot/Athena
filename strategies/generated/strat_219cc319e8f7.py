...
class Strategy_strat_219cc319e8f7(Strategy):
    def __init__(self):
        super().__init__()
        self.fast_period = 32
        self.slow_period = 149
        self.trend_threshold = 0.006408440417855091
        self.rsi_period = 30
        self.rsi_overbought = 83
        self.rsi_oversold = 36
        self.position_size = 0.21533748816079423
